...
CREATE TYPE fulfillment_status AS ENUM ('new','confirmed','packing','dispatched','delivered','cancelled');
...
CREATE TABLE system_audit_logs (id uuid PRIMARY KEY DEFAULT gen_random_uuid(), event varchar(80) NOT NULL, actor varchar(120) NOT NULL DEFAULT 'system', target_code varchar(100), details text NOT NULL, created_at timestamptz NOT NULL DEFAULT now());
